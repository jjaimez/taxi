...
if ($afected > 0) {
	...
	while($row = mysqli_fetch_object($q)) 
					{ 	
						...
						echo "<p><form action='' method='post' id='formRespuesta".$row->id."'> <input type='hidden' values='' id='hiddenInput".$row->id."' name='hiddenInput'><input type='hidden' values='' id='hiddenid".$row->id."' name='hiddenid'></form>";
